# -*- coding: utf-8 -*-
#
# owh documentation build configuration file, created by
...
file_text = read(fpath('../owh/__meta__.py'))
...
latex_documents = [
    ('index', 'owh.tex', u'owh Documentation',
        u'Thomas C Hicks', 'manual'),
]
...
texinfo_documents = [
    ('index', 'owh', u'owh Documentation',
        u'Thomas C Hicks', 'owh', 'One line description of project.',
        'Miscellaneous'),
]
